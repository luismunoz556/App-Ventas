<h1 class="nombre-pagina">Menú Principal</h1>

<div class="contenedor-menu">
    <div class="grid-menu">
        <a href="/datos-maestros" class="boton-menu">
            <div class="icono-menu">
            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" 
            stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="icon icon-tabler icons-tabler-outline icon-tabler-file-database">
            <path stroke="none" d="M0 0h24v24H0z" fill="none"/><path d="M12 12.75m-4 0a4 1.75 0 1 0 8 0a4 1.75 0 1 0 -8 0" /><path 
            d="M8 12.5v3.75c0 .966 1.79 1.75 4 1.75s4 -.784 4 -1.75v-3.75" /><path d="M14 3v4a1 1 0 0 0 1 1h4" />
        ...
        <a href="/entradas-productos" class="boton-menu">
            ...
            <p>Registrar entradas de inventario y stock</p>
        </a>

        <a href="/validar-ventas" class="boton-menu">
            <div class="icono-menu">
                <svg width="48" height="48" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
